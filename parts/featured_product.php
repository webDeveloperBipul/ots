                            ...
                            <div class="block-products-carousel__column">
                                <div class="block-products-carousel__cell">
                                    <div class="product-card">
                                        <button class="product-card__quickview" data-toggle="modal" data-target="#quickview-modal" type="button">
                                            <i class="far fa-eye" style="color: gray; font-size:16px;"></i> <span class="fake-svg-icon"></span></button>
